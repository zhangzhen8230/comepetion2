...
def train():
    ...
    for k,(tr,va) in enumerate(StratifiedKFold(Train_label,random_state=27,n_folds=N_FOLD)):
        ...
        print ("Train...")
        checkpoint = ModelCheckpoint('../model_file/esim_{}.hdf5'.format(k), monitor='val_loss', verbose=1,
        ...
        model.load_weights('../model_file/esim_{}.hdf5'.format(k))
    ...
    df_train_result.to_csv('../result/esim1_train.txt',header=False,index=False)
def test():
    "预测得分"
    version = 'esim'
